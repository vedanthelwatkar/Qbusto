...
module.exports = {
  listProducts,
  getProduct,
  createProduct: cache.invalidatingAfter(createProduct),
  updateProduct: cache.invalidatingAfter(updateProduct),
  deactivateProduct: cache.invalidatingAfter(deactivateProduct),
  serializeProduct,
  PUBLIC_ATTRIBUTES,
};
